    ...
    return (
        <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-display relative">
            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                ...
                <h2 className="text-center text-3xl font-black text-slate-900 tracking-tight">Inscription</h2>
                <p className="mt-2 text-center text-sm text-slate-500">
                    Déjà inscrit ? <Link to="/login" className="font-bold text-primary hover:text-primary-600">Connectez-vous ici</Link>
                </p>
            </div>
