            ...
            <main className="flex-grow">
                <section className="relative h-[400px] w-full overflow-hidden bg-slate-900 flex items-center">
                    <div className="absolute inset-0">
                        <img className="w-full h-full object-cover opacity-70" alt="Collection Accessoires Hero" src="https://images.unsplash.com/photo-1523275335684-37898b6baf30?q=80&w=1999&auto=format&fit=crop" />
                    ...
                    <div className="relative max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8">
                        <span className="inline-block px-4 py-1.5 bg-primary/90 text-white text-[10px] font-black tracking-[0.2em] uppercase mb-6 rounded-full shadow-lg">L'Art du Détail</span>
                        <h1 className="text-4xl md:text-7xl font-black text-white mb-6 uppercase tracking-tighter">Nos<br /><span className="text-primary-400">Accessoires</span></h1>
                        <p className="max-w-md text-slate-200 text-lg leading-relaxed font-medium">Sublimez votre style avec notre sélection exclusive d'accessoires de luxe authentiques.</p>
                    </div>
                </section>
