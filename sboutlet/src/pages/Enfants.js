            ...
            <main className="flex-grow">
                <section className="relative h-[400px] w-full overflow-hidden bg-slate-900 flex items-center">
                    <div className="absolute inset-0">
                        <img className="w-full h-full object-cover opacity-70" alt="Collection Enfants Hero" src="https://images.unsplash.com/photo-1543333995-a78439976842?q=80&w=2070&auto=format&fit=crop" />
                    ...
                    <div className="relative max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8">
                        <span className="inline-block px-4 py-1.5 bg-primary/90 text-white text-[10px] font-black tracking-[0.2em] uppercase mb-6 rounded-full shadow-lg">Le Style n'a pas d'âge</span>
                        <h1 className="text-4xl md:text-7xl font-black text-white mb-6 uppercase tracking-tighter">Collection<br /><span className="text-primary-400">Enfants</span></h1>
                        <p className="max-w-md text-slate-200 text-lg leading-relaxed font-medium">Découvrez notre sélection ludique et raffinée pour les petits amateurs de mode.</p>
                    </div>
                </section>
